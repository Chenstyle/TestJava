...
fun main() {
    ...
    /**
     * 在Java中，所有引用都可能为null，然而在Kotlin中，对null是有着严格的检查与限制的，这就使得某个来自与Java的引用在Kotlin中
     * 变得不再适合；基于这个原因，在Kotlin中，将来自与Java的声明类型成为平台类型（Platform Types）。
     *
    ...
    val s1: String = item // 允许，不过可能在运行期失败
